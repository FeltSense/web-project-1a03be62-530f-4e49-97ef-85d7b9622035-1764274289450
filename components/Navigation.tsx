      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0">
            <a href="#" className="text-2xl font-bold text-white font-['Sora'] tracking-tight">
              Ego
            </a>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-6 space-y-4 border-t border-slate-800">
            ...
            <a
              href="#contact"
              onClick={() => setMobileMenuOpen(false)}
              className="block bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl px-6 py-3 transition-all duration-300 shadow-sm hover:shadow-md text-center"
            >
              Get Started
            </a>
          </div>
